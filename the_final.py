...
def file_info():
    ...
    print('\nLekérésre rendelkezésre álló adatok: \n')

    for i in range(0,len(nlist)):
        print(i,nlist[i][0])

    inp = input('Hányadikról szeretnél információt lekérdezni? ')
    inp = int(inp)

    
    print('\n',nlist[inp][0].center(75),'\n')

    for i in range(1,len(nlist[inp])):
        print(nlist[inp][i].center(75))
    
        

print('Válassz az alábbi opciók közül:\n1.Adatok fájlba való mentése\n2.Tudnivalók a nevezetességekről\n3.Kvíz indítása\n4.Évszám szerinti keresés\n5.Ország szerinti keresés\n6.Információ visszakérdezése a fájlból')
